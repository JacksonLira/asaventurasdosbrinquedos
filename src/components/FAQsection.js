...
const FAQSection = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Sim, ao sair do show, estaremos lhe aguardando no banner de fotos.',
    },
    {
  ...
  return (
    <section className=" bg-transparent">
      <div className="grid laptop:grid-cols-3 mobile:grid-cols-1 laptop:grid-rows-4 mobile:grid-rows-5 overflow-hidden gap-4 mobile:gap-1">
        {faqs.map((faq, index) => (
